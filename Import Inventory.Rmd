...
Extracted_Inventory %>% filter(Grade %in% c("HTUSS", "HTR50H", "HTR50"), Length %in% c("17'06\"", "19'04\"", "15'07\"1/4\""), Size=="4") %>% ggplot(aes(Date, `Held Total`, col= Length)) + geom_line() + theme(axis.text.x = element_text(angle=90, hjust=1))

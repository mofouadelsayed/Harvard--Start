...
- Previously we used the separate function to split the values of a certain column into two separate ones. Extract can do the same thing but also extracts those values. It's obvious below that extract works better than separate if patterns become a bit complecated as below.
```{r}
